...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+mysqlconnector://root:password@localhost/marvel'
...
def create_database():
    root_engine = create_engine("mysql+mysqlconnector://root:password@localhost")  # No database specified
